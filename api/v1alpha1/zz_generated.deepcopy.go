...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SQBConfigMap) DeepCopyInto(out *SQBConfigMap) {
	*out = *in
	if in.istioGateways != nil {
		in, out := &in.istioGateways, &out.istioGateways
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SQBConfigMap.
func (in *SQBConfigMap) DeepCopy() *SQBConfigMap {
	if in == nil {
		return nil
	}
	out := new(SQBConfigMap)
	in.DeepCopyInto(out)
	return out
}
